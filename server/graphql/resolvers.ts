...
const resolvers = {
  ...
  Mutation: {
    ...
    updateLink: async (_parent: any, args: any, _ctx: any): Promise<any> => {
      ...
      if (oldLink !== "Failed") {
        const result = await updateLink(
          args.linkId,
          args.annotation ? args.annotation : oldLink.annotation,
          args.url ? args.url : oldLink.url,
          args.tags ? args.tags : oldLink.tags,
          args.note ? args.note : oldLink.note
        );
    ...
    addCollectionChild: async (
      ...
      const updatedCollection = await dropCollectionToCollection(
        args.collectionId,
        newCollection.key
      );
